              ...
              <Row>
                <Col xs={12} md={4} className="mt-3 mt-md-0">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <Link to="/urunlerimiz">Ürünlerimiz</Link>
                    </li>
                    <li>
                      <Link to="/sorular">Sorular</Link>
                    </li>
                    <li>
                      <Link
                        target="_blank"
                ...
                <Col xs={12} md={4} className="mt-3 mt-md-0">
                  ...
                  <ul className="list-unstyled">
                    ...
                    <li>
                      <Link to="/yasal-bilgiler">Yasal Bilgiler</Link>
                    </li>
                    <li>
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <a
                        target="_blank"
                        rel="noopener noreferrer"
                        href="https://facebook.com/tokyaykereste"
                      >
                        <img
                    ...
                    <li>
                      <a
                        target="_blank"
                        rel="noopener noreferrer"
                        href="https://instagram.com/tokyaykereste"
                      >
                        <img
                    ...
                    <li>
                      <a
                        target="_blank"
                        rel="noopener noreferrer"
                        href="https://twitter.com/tokyaykereste"
                      >
                        <img
